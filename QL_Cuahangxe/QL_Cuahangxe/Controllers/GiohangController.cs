...
namespace QL_Cuahangxe.Controllers
{
    public class GiohangController : Controller
    {
        ...
        {
            List<Giohang> lstGiohang = Laygiohang();
            Giohang sanpham = lstGiohang.FirstOrDefault(n => n.iMaxe == iMaSP);
            if (sanpham != null)
            {
            ...
            {
                return RedirectToAction("Index", "Motobike");
            }
            return RedirectToAction("Giohang");
        ...
        public ActionResult DatHang(FormCollection collection)
        {
            ...
            qlCuahangxeEntities.DONDATHANGs.Add(ddh);
            qlCuahangxeEntities.SaveChanges();
            ...
            foreach (var item in gh)
            {
                ...
                qlCuahangxeEntities.CHITIETDONTHANGs.Add(ctdh);
            }
            qlCuahangxeEntities.SaveChanges();
